...
public class Restaurants extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word(getString(R.string.restaurant_one), getString(R.string.restaurant_one_description)));
        words.add(new Word(getString(R.string.restaurant_two), getString(R.string.restaurant_two_description), R.drawable.dominos_pizza));
        words.add(new Word(getString(R.string.restaurant_three), getString(R.string.restaurant_three_description),R.drawable.pizza_hut));
        words.add(new Word(getString(R.string.restaurant_four), getString(R.string.restaurant_four_description)));
