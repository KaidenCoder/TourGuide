...
public class CityEvents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word(getString(R.string.city_one), getString(R.string.city_one_description), R.drawable.gandhi_mela));
        words.add(new Word(getString(R.string.city_two),getString(R.string.city_two_description), R.drawable.durga_puja));

        // Create an {@link WordAdapter}, whose data source is a list of {@link Word}s. The
        // adapter knows how to create list items for each item in the list.
        WordAdapter adapter = new WordAdapter(this, words, R.color.cityEvents);
